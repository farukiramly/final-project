...
year = st.sidebar.slider("What year the house build you want?",int(data.yr_built.min()),int(data.yr_built.max()),int(data.yr_built.mean()) )
...
st.sidebar.subheader('Github source code can find [*here*](https://github.com/farukiramly/final-project)')
